...
# The third view is the joint of first view and second view by listing_id = id
...
cursor.execute(''' CREATE VIEW airbnb_view AS
                SELECT DISTINCT t1.*, t2.*
                FROM most_recent_calendar t1
                JOIN most_recent_listings t2
